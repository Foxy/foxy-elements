...
const THEME_PRESETS: Record<string, ThemePreset> = {
  ...
  "Neo Brutalism": {
    ...
    themeColorPrimary: "#db0c00",
    themeColorSecondary: "#000000",
    themeColorError: "#000000",
    themeColorFaint: "#000000",
    themeBackgroundPage: "#f2f2f2",
    themeColorOnPrimary: "#ffffff",
    themeBackgroundButtonPrimary: "#ffd600",
    themeBackgroundError: "#000000",
    themeBorderField: "0.125rem solid #000000",
    themeBorderDefault: "0.125rem solid #000000",
  ...
  "Amethyst Haze": {
    ...
    themeColorPrimary: "#74609d",
    themeColorSecondary: "#6f6785",
    themeColorFaint: "#6f6785",
    themeBackgroundPage: "#efecf5",
    ...
    themeBorderField: "0.0625rem solid #d3c9e3",
    themeBorderDefault: "0.0625rem solid #d3c9e3",
    themeOutlinePrimary: "0.1875rem solid #e4dcf0",
    themeFontBody: "400 1rem/1.5 'Manrope', sans-serif",
    themeBorderRadiusSm: "0.625rem",
    themeBorderRadiusXs: "0.3125rem",
    themeBorderRadiusMd: "1.25rem",
    themeSpaceMd: "0.75rem",
    themeSizeControl: "2.5rem",
    themeSizeBorderWidth: "0.0625rem",
  },
  "Midnight Slate": {
    ...
    themeColorFaint: "#878ea0",
    themeBackgroundPage: "#191b22",
    ...
    themeBorderField: "0.0625rem solid #4a4f5e",
    themeBorderDefault: "0.0625rem solid #4a4f5e",
  ...
  "High Contrast Dark": {
    ...
    themeColorFaint: "#c9cfd9",
    themeBackgroundPage: "#000000",
    ...
    themeBorderField: "0.125rem solid #9fa6b5",
    themeBorderDefault: "0.125rem solid #9fa6b5",
    themeOutlinePrimary: "0.25rem solid #7ec8ff",
    themeFontBody: "500 1rem/1.5 'IBM Plex Sans', sans-serif",
    themeBorderRadiusSm: "0.375rem",
    themeBorderRadiusXs: "0.1875rem",
    themeBorderRadiusMd: "0.75rem",
    themeSpaceMd: "0.75rem",
    themeSizeControl: "2.75rem",
    themeSizeBorderWidth: "0.125rem",
  },
