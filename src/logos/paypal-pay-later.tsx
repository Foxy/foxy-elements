export function PayPalPayLaterLogo() {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="7.056000232696533 3 37.35095977783203 45" height="28" aria-hidden="true">
      ...
      <span style={{ color: "#000", fontSize: "1rem", fontFamily: "inherit", whiteSpace: "nowrap" }}>Pay Later</span>
    </>
  );
}
