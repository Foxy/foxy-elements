...
<Subtitle>
  A secure, PCI-compliant way to collect payment information with support for Stripe, Square and embedded gateways.
</Subtitle>
...
<foxy-payment-card-embed url="https://embed.foxy.io/v1?template_set_id=123"></foxy-payment-card-embed>
`} isExpanded>
  <Story name="Default">{() => html`<foxy-payment-card-embed lang="en" url="https://embed.foxy.io/v1?demo=default"></foxy-payment-card-embed>`}</Story>
  <Story name="Stripe">{() => html`<foxy-payment-card-embed lang="en" url="https://embed.foxy.io/v1?demo=stripe"></foxy-payment-card-embed>`}</Story>
  <Story name="Square">{() => html`<foxy-payment-card-embed lang="en" url="https://embed.foxy.io/v1?demo=square"></foxy-payment-card-embed>`}</Story>
</Canvas>
  ...
  i18next.addResourceBundle('es', 'my-payment-card-embed', {
    "default": {
      ...
      "status": {
        ...
        "misconfigured": "Este formulario no está configurado correctamente. Si está viendo este mensaje como cliente, informe este problema al equipo de soporte de la tienda."
      }
    }
  });
</script>
...
<Canvas mdxSource={`<foxy-payment-card-embed url="https://embed.foxy.io/v1?template_set_id=123" disabled></foxy-payment-card-embed>`} isExpanded>
  <Story name="DefaultDisabled">{() => html`<foxy-payment-card-embed lang="en" url="https://embed.foxy.io/v1?demo=default" disabled></foxy-payment-card-embed>`}</Story>
  <Story name="StripeDisabled">{() => html`<foxy-payment-card-embed lang="en" url="https://embed.foxy.io/v1?demo=stripe" disabled></foxy-payment-card-embed>`}</Story>
  <Story name="SquareDisabled">{() => html`<foxy-payment-card-embed lang="en" url="https://embed.foxy.io/v1?demo=square" disabled></foxy-payment-card-embed>`}</Story>
</Canvas>

### Readonly

<Canvas mdxSource={`<foxy-payment-card-embed url="https://embed.foxy.io/v1?template_set_id=123" readonly></foxy-payment-card-embed>`} isExpanded>
  <Story name="DefaultReadonly">{() => html`<foxy-payment-card-embed lang="en" url="https://embed.foxy.io/v1?demo=default" readonly></foxy-payment-card-embed>`}</Story>
  <Story name="StripeReadonly">{() => html`<foxy-payment-card-embed lang="en" url="https://embed.foxy.io/v1?demo=stripe" readonly></foxy-payment-card-embed>`}</Story>
  <Story name="SquareReadonly">{() => html`<foxy-payment-card-embed lang="en" url="https://embed.foxy.io/v1?demo=square" readonly></foxy-payment-card-embed>`}</Story>
</Canvas>
...
element.tokenize().then(cardToken => {
...
- Default form: `https://embed.foxy.io/v1?demo=default`
- Stripe Card: `https://embed.foxy.io/v1?demo=stripe`
- Square Card: `https://embed.foxy.io/v1?demo=square`
