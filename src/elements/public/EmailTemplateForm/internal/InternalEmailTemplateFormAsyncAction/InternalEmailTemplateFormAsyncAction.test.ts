...
describe('EmailTemplateForm', () => {
  describe('InternalEmailTemplateFormAsyncAction', () => {
    ...
    it('imports and defines itself as foxy-internal-email-template-form-async-action', () => {
      expect(customElements.get('foxy-internal-email-template-form-async-action')).to.equal(
        Control
      );
    });
    ...
    it('renders themed action button with translatable label', async () => {
      const control = await fixture<Control>(html`
        <foxy-internal-email-template-form-async-action infer="foo" theme="error">
    ...
    it('disables the action button when the control is disabled', async () => {
      const control = await fixture<Control>(html`
        <foxy-internal-email-template-form-async-action disabled>
        </foxy-internal-email-template-form-async-action>
      `);
