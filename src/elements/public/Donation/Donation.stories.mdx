...
<a href="https://wiki.foxycart.com/v/2.0/cheat_sheet#transaction_non-product_specific_options" target="_blank">Please, refer to the documentation for more details</a>.
...
Our elements are built with Vaadin Lumo theme and therefore share the list of CSS Custom Properties with it. You can find the latest documentation and theme editor on <a href="https://demo.vaadin.com/lumo-editor/" target="_blank">demo.vaadin.com</a>.
