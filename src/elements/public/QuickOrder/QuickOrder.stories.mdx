...
You can achieve this by providing a new products array or you may choose to remove a product.

You will need to use the product id called `pid`.
...
<Preview>
  <Story name="Removing a product by Product Id">
    ...
    <foxy-order-form store="jamstackecommerceexample.foxycart.com" currency="usd">
        ...
        <button type="button" 
              style="background: #ededed; box-shadow: 1px 1px 2px #ddd; border-radius: 6px; padding: 0.3em 1em"
              onclick="this.parentElement.removeProducts([1]);">Remove product 1</button>
    </foxy-order-form>
    `}
  </Story>
</Preview>
