...
<Preview>
  <Story name="Changing the products list">
    {html`
    ...
    <button type="button" onclick="document.querySelector('#to-change-product-list').products = [{name:'Changed', price: 5}];"> Change me </button>
    `}
  </Story>
</Preview>
