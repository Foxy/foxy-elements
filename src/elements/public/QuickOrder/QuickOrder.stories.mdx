  ...
  <Story name="Minimal attributes approach">
    ...
    <div class="container-narrow">
      <foxy-order-form store="jamstackecommerceexample.foxycart.com"
                       currency="usd"
                       products='[{"name":"Cool Product", "price": 5}]'
                       >
      </foxy-order-form>
    </div>
    `}
...
<Preview>
  ...
  <foxy-order-form
      ...
      currency="usd"
  >
      <foxy-item name="Bundle Package" price="0.00" image="https://www.foxy.io/merchants/shopping-cart-full.svg">
        <foxy-item name="The smart choice" price="50.00" image="https://www.foxy.io/merchants/shopping-cart-full.svg"> </foxy-item>
        <foxy-item name="The interesting bit" price="30.00" image="https://www.foxy.io/merchants/shopping-cart-full.svg"> </foxy-item>
      </foxy-item>
    </foxy-order-form>
    `}
  </Story>
...
<Preview>
  ...
  <foxy-order-form
      ...
      currency="usd"
  >
      <foxy-item name="Purple Jacket" description="Just this month!! Buy a Purple Jacket and get Purple Pants and Purple boots for $40 each!" price="80.00" image="https://www.foxy.io/merchants/shopping-cart-full.svg">
        <foxy-item name="Purple pants" price="40.00" image="https://www.foxy.io/merchants/shopping-cart-full.svg"> </foxy-item>
        <foxy-item name="Purple boots" price="40.00" image="https://www.foxy.io/merchants/shopping-cart-full.svg"> </foxy-item>
      </foxy-item>
    </foxy-order-form>
    `}
  </Story>
