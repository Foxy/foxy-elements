...
The `<foxy-item></foxy-item>` custom element has a `description` slot and a default slot.

The `description` slot is used to add a rich description to your product.

The unnamed ― default ― slot is used to add child products.
You can also add any custom markup to it that may be needed to better organize your child products.

<Preview>
  <Story name="Product slots">
    {html`
    <foxy-order-form currency="usd">
      <style>
      .dietary-food {
      ...
      <h2>diet food</h2>
        <foxy-item name="Health package"
                   description="The world class nutrition pack for your pet. This nutrition pack provides your pet with the world's best nutrition, combined with the perfect food to recover after intense competitions."
                   price="0" >
          <section class="dietary-food" >
            <foxy-item name="A1 Health" price="89.99"
              image="https://www.foxy.io/merchants/shopping-cart-full.svg"
              description="Scientific food, perfect nutrition"
              >
            </foxy-item>
            <foxy-item name="A1 Restore" price="99.99"
              image="https://www.foxy.io/merchants/shopping-cart-full.svg"
              description="Sport food to high intensity athletes"
              >
            </foxy-item>
          </section>
        </foxy-item>
