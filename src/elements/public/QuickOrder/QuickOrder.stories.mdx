...
Child products allow you to bundle a set of products together. You can achieve
this by nesting `foxy-item` custom tags, or using the `products` product of the product object within the JS array.
