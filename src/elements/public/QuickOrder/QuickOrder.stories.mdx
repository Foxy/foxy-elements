...
<Canvas
    mdxSource={html`<foxy-quick-form store="jamstackecommerceexample.foxycart.com" currency="usd">
      </foxy-quick-form>
    `}
    >
...
<Canvas>
  ...
  >
      <foxy-item name="Purple Jacket" description="Just this month!! Buy a Purple Jacket and get Purple Pants and Purple boots for $40 each!" price="80.00" image="http://placedog.net/200">
        <foxy-item slot="products" name="Purple pants" price="40.00" image="http://placedog.net/200">
           <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Satis est ad hoc responsum. Beatus autem esse in maximarum rerum timore nemo potest.</div>
        </foxy-item>
        <foxy-item slot="products" name="Purple boots" price="40.00" image="http://placedog.net/200">
           <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Satis est ad hoc responsum. Beatus autem esse in maximarum rerum timore nemo potest.</div>
        </foxy-item>
      </foxy-item>
    </foxy-quick-form>
