...
<Preview>
  <Story name="Minimal slots approach">
    {html`
    <div class="container-narrow">
      <foxy-order-form store="jamstackecommerceexample.foxycart.com" currency="usd">
        ...
        <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Satis est ad hoc responsum. Beatus autem esse in maximarum rerum timore nemo potest. Iam id ipsum absurdum, maximum malum neglegi. Haeret in salebra. Quasi ego id curem, quid ille aiat aut neget. Istam voluptatem perpetuam quis potest praestare sapienti?</div>
        </foxy-item>
      </foxy-order-form>
    </div>
    `}
...
<Preview>
  <Story name="Minimal attributes approach">
    {html`
    <div class="container-narrow">
      <foxy-order-form store="jamstackecommerceexample.foxycart.com"
                       currency="usd"
                       products='[{"name":"Cool Product", "price": 5, "image":"https://placedog.net/200", "quantity": 2, "description": "I do deserve a tasty food" }]'
                       >
      </foxy-order-form>
    </div>
    `}
...
By adding `<foxy-items>` to your `<foxy-order-form>` your products will be properly added to the order.
...
Please, note that `foxy-order-form` will not find them if they are in a Shadow DOM.
  ...
  >
      <foxy-item name="Bundle Package" price="0.00" image="http://placedog.net/200">
        ...
        <foxy-item slot="products" name="The smart choice" price="50.00" image="http://placedog.net/200" quantity="3">
          The smart choice is one your puppy is always trying to do, but need you to lead the way.
        </foxy-item>
        <foxy-item slot="products" name="The interesting bit" price="30.00" image="http://placedog.net/200" quantity="2">
          The world is full of interesting stuff but there is but one <strong>interesting bit</strong>, that's for sure.
        </foxy-item>
      </foxy-item>
    </foxy-order-form>
    `}
...
<Preview>
  <Story name="Package deal">
    {html`
  <foxy-order-form
      store="jamstackecommerceexample"
      currency="usd"
  >
      <foxy-item name="Purple Jacket" description="Just this month!! Buy a Purple Jacket and get Purple Pants and Purple boots for $40 each!" price="80.00" image="http://placedog.net/200">
        <foxy-item slot="products" name="Purple pants" price="40.00" image="http://placedog.net/200"> </foxy-item>
        <foxy-item slot="products" name="Purple boots" price="40.00" image="http://placedog.net/200"> </foxy-item>
      </foxy-item>
    </foxy-order-form>
    `}
  </Story>
...
<Preview>
    <Story name="Start and End Dates" >
      {html`
    <div class="container-narrow">
      <foxy-order-form frequencies='["1d", "1w", ".5m", "1m"]'
                       store="jamstackecommerceexample"
                       currency="usd"
...
You can set a new list of products by changing the `products` attribute of the `foxy-order-form`.
...
<Preview>
  <Story name="Add an array of products" >
    {html`
		<div style="max-width: 800px; border: solid thin silver; padding: 1em; margin: 0 auto">
    <foxy-order-form frequencies='["1d", "1w", ".5m", "1m"]'
                     store="jamstackecommerceexample"
...
<Preview>
  <Story name="Removing a product by Product Id">
    {html`
    <foxy-order-form store="jamstackecommerceexample.foxycart.com" currency="usd">
        <foxy-item name="pup dog food"
                   price="59.99"
