  ...
  describe('CategoryRestrictionsPage', () => {
    describe('CategoryRestrictionsPageItem', () => {
      ...
      it('has no default gift card URL', () => {
        expect(new CategoryRestrictionsPageItem()).to.have.property('giftCard', '');
      });
      ...
      it('renders CategoryRestrictionsPageItemContent element when loaded (match found)', async () => {
        ...
        const element = await fixture<CategoryRestrictionsPageItem>(html`
          <test-category-restrictions-page-item
            ...
            group="test"
            href="https://demo.api/hapi/gift_card_item_categories?gift_card_id=0&item_category_id=0"
            lang="es"
            ns="foo"
        ...
        const match = element.data!._embedded['fx:gift_card_item_categories'][0];
        ...
        expect(content).to.have.attribute('gift-card', element.giftCard);
