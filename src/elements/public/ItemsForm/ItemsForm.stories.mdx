      ...
      items: [
        {
          "name":"Sponsor a Dog",
          "price": 5,
          "image":"https://global-uploads.webflow.com/5ca2c23040d228c594f99c14/5cb8abee70d87a69f20549e0_bird-bag.png",
          "quantity": 1,
          "description": "I do deserve a tasty food!"
        },{
          "name":"Sponsor a Cat",
  ...
  mdxSource={dedent`
    <foxy-items-form store="jamstackecommerceexample.foxycart.com" currency="usd">
      ...
      <section class="bg-green-100 border border-green-500 rounded-lg m-6">
        <foxy-item name="Sci-fy Bites" quantity="1" price="69.99" image="http://placedog.net/200">
...
<Canvas
  mdxSource={dedent`
    <foxy-items-form store="jamstackecommerceexample.foxycart.com" currency="usd" frequencies='["1d", "1w", ".5m", "1m", "3m"]'>
      <foxy-item name="Pup Dog Food" description="Daily meal for your friend" quantity="1" price="69.99" image="http://placedog.net/200"></foxy-item>
    </foxy-items-form>
  `}
>
...
<Canvas
  mdxSource={dedent`
    <foxy-items-form store="jamstackecommerceexample" currency="usd">
      <foxy-item name="Bundle Package" quantity="1" price="0.00" image="http://placedog.net/200">
        <p>The most avanced dog food bundle you will find out there. Well balanced, delicious and scientifically evaluated.</p>
        <foxy-item slot="items" name="The smart choice" quantity="1" price="50.00" image="http://placedog.net/200" quantity="3">
          <div>The smart choice is one your puppy is always trying to do, but need you to lead the way.</div>
        </foxy-item>
        <foxy-item slot="items" name="The interesting bit" quantity="1" price="30.00" image="http://placedog.net/200" quantity="2">
...
<Canvas
  mdxSource={dedent`
    <foxy-items-form store="jamstackecommerceexample" currency="usd">
      <foxy-item name="Bundle Package" quantity="1" price="10.00" image="http://placedog.net/200"></foxy-item>
...
>
  <Story
    ...
    args={{
      ...
      itemsToAdd: [{ name: 'My new item', quantity: 1, price: 4.2, image: 'http://placedog.net/200' }],
    }}
  >
    {args => html`
      <div id="tochange">
