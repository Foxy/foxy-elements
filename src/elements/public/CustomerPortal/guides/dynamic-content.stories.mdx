...
<script type="module">
  import 'https://unpkg.com/@foxy.io/elements/dist/cdn/foxy-customer-portal.js';

  const I18nElement = customElements.get('foxy-i18n');
  const i18nBase = 'https://unpkg.com/@foxy.io/elements/dist/cdn/translations';
...
<script type="module">
  ...
  import 'https://cdn.skypack.dev/@foxy.io/elements/dist/cdn/foxy-customer-portal.js';
