...
<Story name="Localdev">
  {() =>
    html`
      <foxy-customer-api base="https://serverless.foxycart.test:3000/s/customer/" storage="local">
        <foxy-customer-portal href="https://serverless.foxycart.test:3000/s/customer">
