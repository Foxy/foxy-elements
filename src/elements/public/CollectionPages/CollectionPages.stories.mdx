...
- `html` - tag function from <a href="https://lit-html.polymer-project.org/guide#lit-html-templates" target="_blank">lit-html</a>. Render function is expected to return the output of this tag function.
