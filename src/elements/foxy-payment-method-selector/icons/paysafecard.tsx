...
// Derived from Adyen's hosted paysafecard payment method logo.
// viewBox crops to the wordmark content area (clip rect at y=10, h=5.61 within
// the original 40×26 frame), with padding so nothing is cut off.
export default function PaysafecardMarkIcon({
  className,
}: {
  className?: string;
}): ReactNode {
